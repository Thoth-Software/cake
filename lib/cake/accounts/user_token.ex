defmodule Cake.Accounts.UserToken do
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, Cake.Accounts.User, type: :binary_id
  ...
  """
  @spec build_session_token(%Cake.Accounts.User{}) :: {binary(), %__MODULE__{}}
  ...
  """
  @spec build_email_token(%Cake.Accounts.User{}, String.t()) :: {String.t(), %__MODULE__{}}
  ...
  """
  @spec by_user_and_contexts_query(%Cake.Accounts.User{}, :all | [String.t()]) :: Ecto.Query.t()
